document.addEventListener("DOMContentLoaded", () => {
    ...
    const headImages = ["head1.svg", "head2.svg", "head3.svg", "head4.svg"];
    ...
    const noseImages = ["nose1.svg", "nose2.svg", "nose3.svg"];
    ...
    document.getElementById("headButton").addEventListener("click", function () {
      currentHeadIndex = changeBackgroundImage(
        "headDiv",
        headImages,
        currentHeadIndex
      );
    ...
    document.getElementById("hairButton").addEventListener("click", function () {
      currentHairIndex = changeBackgroundImage(
        "hairDiv",
        hairImages,
        currentHairIndex
      );
    ...
    document
      .getElementById("eyebrowsButton")
      .addEventListener("click", function () {
        currentEyebrowsIndex = changeBackgroundImage(
          "eyebrowsDiv",
          eyebrowsImages,
    ...
    document.getElementById("eyesButton").addEventListener("click", function () {
      currentEyesIndex = changeBackgroundImage(
        "eyesDiv",
        eyesImages,
        currentEyesIndex
      );
    ...
    document.getElementById("noseButton").addEventListener("click", function () {
      currentNoseIndex = changeBackgroundImage(
        "noseDiv",
        noseImages,
        currentNoseIndex
      );
    ...
    document.getElementById("mouthButton").addEventListener("click", function () {
      currentMouthIndex = changeBackgroundImage(
        "mouthDiv",
        mouthImages,
        currentMouthIndex
      );
    ...
    document
      .getElementById("glassesButton")
      .addEventListener("click", function () {
        currentGlassesIndex = changeBackgroundImage(
          "glassesDiv",
          glassesImages,
          currentGlassesIndex
        );
    ...
    //     const divToCapture = document.getElementById("head");
    ...
    document
      ...
      .addEventListener("click", function (e) {
        ...
        if (userName === "") {
          ...
          canvas.width = 314; // Set the desired width
